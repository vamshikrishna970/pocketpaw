...
- **Status**: Beta
- **Provider support**: Copilot, OpenAI, Azure, Anthropic
...
|---------|-------------|---------|-------------|
| `copilot_sdk_provider` | `POCKETPAW_COPILOT_SDK_PROVIDER` | `"copilot"` | Provider: `copilot`, `openai`, `azure`, `anthropic` |
...
<Tabs items={["Copilot (default)", "OpenAI", "Azure", "Anthropic"]}>
