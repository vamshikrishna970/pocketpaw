...
The OpenAI Agents backend supports [OpenRouter](https://openrouter.ai) as a provider, giving access to 100+ models through a single API:

```bash
export POCKETPAW_AGENT_BACKEND="openai_agents"
export POCKETPAW_LLM_PROVIDER="openai_compatible"
export POCKETPAW_OPENAI_COMPATIBLE_BASE_URL="https://openrouter.ai/api/v1"
export POCKETPAW_OPENAI_API_KEY="your-openrouter-key"
export POCKETPAW_OPENAI_MODEL="anthropic/claude-sonnet-4-20250514"
```
